...
#define DEFAULT_URL "http://www.naoj.org/Instruments/HDS/hoe/"

#define VER_HOST "www.naoj.org"
#define VER_PATH "/Instruments/HDS/hoe/ver"
...
#define MAST_URL "open https://archive.stsci.edu/xcorr.php?target=%.5lf%s%.10lf\\&max_records=10\\&action=Search\\&resolver=SIMBAD\\&missions[]=EUVE\\&missions[]=WFC3-IMAGE\\&missions[]=WFPC1\\&missions[]=WFPC2\\&missions[]=FOC\\&missions[]=ACS-IMAGE\\&missions[]=UIT\\&missions[]=STIS-IMAGE\\&missions[]=COS-IMAGE\\&missions[]=GALEX\\&missions[]=XMM-OM\\&missions[]=NICMOS-IMAGE\\&missions[]=FUSE\\&missions[]=IMAPS\\&missions[]=BEFS\\&missions[]=TUES\\&missions[]=IUE\\&missions[]=COPERNICUS\\&missions[]=HUT\\&missions[]=WUPPE\\&missions[]=GHRS\\&missions[]=STIS-SPECTRUM\\&missions[]=COS-SPECTRUM\\&missions[]=WFC3-SPECTRUM\\&missions[]=ACS-SPECTRUM\\&missions[]=FOS\\&missions[]=HPOL\\&missions[]=NICMOS-SPECTRUM\\&missions[]=FGS\\&missions[]=HSP\\&missions[]=KEPLER"
...
// UCAC4
enum {UCAC_BAND_B,UCAC_BAND_G,UCAC_BAND_V,UCAC_BAND_R,UCAC_BAND_I,
      UCAC_BAND_J,UCAC_BAND_H,UCAC_BAND_K,NUM_UCAC_BAND};
static const char* 
ucac_band[NUM_UCAC_BAND] = {"B","g","V","r","i","J","H","K"};
// SDSS --> post_sdss.h
// PS1
...
struct _OBJpara{
  ...
  */
  ...
  gdouble magdb_gsc_h;
  gdouble magdb_gsc_k;
  gdouble magdb_ucac_b;
  gdouble magdb_ucac_g;
  gdouble magdb_ucac_v;
  gdouble magdb_ucac_r;
  gdouble magdb_ucac_i;
  gdouble magdb_ucac_j;
  gdouble magdb_ucac_h;
  gdouble magdb_ucac_k;
  gdouble magdb_ps1_g;
  gdouble magdb_ps1_r;
  gdouble magdb_ps1_i;
  gdouble magdb_ps1_z;
  gdouble magdb_ps1_y;
  gdouble magdb_ps1_apsf;
...
struct _typHOE{
  ...
  gint  service_i_max;
  gint  service_i_obj_all;
  gint service_time_all;
  gdouble service_JD_in[MAX_SVC];
  gdouble service_JD0[MAX_SVC];
  gdouble service_JD1[MAX_SVC];
  gdouble service_JD_st_min[MAX_SVC];
  gdouble service_JD_st_max[MAX_SVC];
  gdouble service_JD_ed_min[MAX_SVC];
  gdouble service_JD_ed_max[MAX_SVC];
  gdouble service_moon[MAX_SVC];
  gint  service_i_obj[MAX_SVC];
  gint service_time[MAX_SVC];
  gchar *service_alloc[MAX_SVC];
